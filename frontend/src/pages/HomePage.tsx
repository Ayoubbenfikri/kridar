...
/**
 * Placeholder home page - proves the SPA can reach the Laravel API.
 * Gets replaced by the real listing/search page in Phase 16.
 */
...
export default function HomePage() {
  ...
  return (
    <main className="flex min-h-[70vh] flex-col items-center justify-center gap-4 p-8 text-center">
      <h1 className="text-3xl font-semibold text-brand-700">Kridar</h1>
      <p className="text-brand-500">Phase 15 - authentification</p>
