      ...
      {stats && (
        <>
          <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
            <Link
              to="/owner/properties"
              className="rounded-lg border border-gray-200 p-4 shadow-sm transition hover:-translate-y-1.5 hover:border-brand-300 hover:shadow-xl"
            >
            ...
            <div className="rounded-lg border border-gray-200 p-4 shadow-sm transition hover:-translate-y-1.5 hover:shadow-xl">
          ...
          <div className="space-y-2">
            {pendingReservations.map((reservation) => (
              <Link
                key={reservation.id}
                to="/owner/reservations"
                className="flex items-center justify-between rounded-lg border border-gray-200 px-4 py-3 shadow-sm transition hover:-translate-y-1.5 hover:border-brand-300 hover:shadow-xl"
              >
                <div>
