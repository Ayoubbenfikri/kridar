      ...
      {stats && (
        <>
          <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
            ...
            <div className="rounded-xl border border-brand-100 p-4 shadow-lg shadow-brand-900/10 transition hover:-translate-y-1.5 hover:border-brand-300 hover:shadow-2xl hover:shadow-brand-900/25">
