    ...
    <main className="mx-auto max-w-4xl px-4 py-8">
      <div className="mb-6 flex items-center justify-between">
        ...
        <Link
          ...
          className="rounded-lg bg-brand-600 px-3 py-1.5 text-sm font-semibold text-white transition hover:-translate-y-px hover:bg-brand-700 hover:shadow-md"
        >
        ...
        <>
          <div className="space-y-3">
            {data.data.map((property) => {
              ...
              return (
                <div key={property.id} className="flex flex-wrap items-center gap-4 rounded-xl border border-gray-200 p-4 shadow-sm transition duration-200 hover:-translate-y-1 hover:border-gray-300 hover:shadow-lg">
                  ...
                  {property.status === 'suspended' ? (
                    ...
                    <button
                      ...
                      disabled={isMutatingThis}
                      className="shrink-0 rounded-lg bg-brand-600 px-3 py-1.5 text-sm text-white font-semibold transition hover:-translate-y-px hover:bg-brand-700 hover:shadow-md disabled:pointer-events-none disabled:opacity-50"
                    >
